...
const wordCounter = (value) => {
  ...
  if (value) {
    ...
    // The line takes words and splits them by spaces. If I want to count the letters, remove the space in the parenthesis
    const words = value.split(" ");
    // This line counts how many words within the box
    let count = words.length
    //This line targets the number of words.
